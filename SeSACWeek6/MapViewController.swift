...
/*
 권한: 반영이 조금씩 느릴 수 있음. 지웠다가 실행한다고 하더라도. 한 번 혀용
 설정: 앱이 바로 안 뜨는 경우도 있을 수 있음. 뜨시는 분들은 설정 쪽에서 다음 번에 묻기로 변경
 */
...
//        checkUserDeviceLocationServiceAuthorization() *제거 가능한 이유 명확히 알기!*
        ...
        //37.548230, 126.920935
        let center = CLLocationCoordinate2D(latitude: 37.548230, longitude: 126.920935)
    ...
    func setRegionAnnotation(center: CLLocationCoordinate2D) {
        ...
        annotation.title = "이곳은 이번주 금요일 약속 장소이다"
...
extension MapViewController: CLLocationManagerDelegate {
    ...
    //허용했어서 위치를 가지고오는 중에, 설정에서 거부하고 돌아온다면??
